          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-primary-foreground animate-slide-up">
              ...
              <p className="text-lg md:text-xl text-primary-foreground/70 mb-8 max-w-lg">
                Camisetas personalizadas de alta qualidade. Transforme suas
                ideias em peças únicas que contam a sua história.
              </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
            {features.map((feature, index) => (
              ...
              >
                ...
                <h3 className="font-display text-lg mb-2 tracking-wide">
                  {feature.title}
                </h3>
        ...
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Confira as camisetas mais populares da nossa coleção, escolhidas
              pelos nossos clientes mais exigentes.
            </p>
          </div>
            ...
            <div className="relative z-10 grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-primary-foreground/70 mb-6">
                  Envie sua própria foto e veja como ficará na camiseta em tempo
                  real. Transforme suas melhores memórias em peças exclusivas!
                </p>
      ...
      <section className="section-padding bg-gradient-hero text-primary-foreground">
        <div className="container-custom text-center">
          ...
          <p className="text-primary-foreground/70 text-lg mb-8 max-w-2xl mx-auto">
            ...
            Nossa equipe está pronta para ajudar você a criar a camiseta
            perfeita.
          </p>
          <Button variant="hero" size="xl" asChild>
            <Link to="/contato">
