...
const values = [
  {
    ...
    title: "Paixão",
    description:
      "Amamos o que fazemos e isso reflete em cada peça que criamos.",
  },
  {
    icon: Award,
    title: "Qualidade",
    description:
      "Utilizamos os melhores materiais e técnicas de impressão do mercado.",
  },
  {
    icon: Users,
  ...
  },
  {
    ...
    description:
      "Comprometidos com práticas eco-friendly em toda nossa produção.",
  },
];
      ...
      <section className="bg-gradient-hero text-primary-foreground section-padding">
        <div className="container-custom text-center">
          ...
          <p className="text-primary-foreground/70 text-lg max-w-2xl mx-auto">
            Conheça a CustomTee e descubra como transformamos criatividade em
            realidade vestível.
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  A CustomTee nasceu em 2018 da paixão de um grupo de amigos por
                  moda e arte. O que começou como um pequeno projeto em uma
                  garagem, hoje é uma das principais referências em camisetas
                  personalizadas do Brasil.
                </p>
                <p>
                  Nossa missão sempre foi clara: dar às pessoas a oportunidade
                  de expressar sua individualidade através de peças únicas e de
                  alta qualidade. Acreditamos que cada pessoa tem uma história
                  para contar, e suas roupas são uma extensão dessa narrativa.
                </p>
                <p>
                  Ao longo dos anos, investimos em tecnologia de ponta para
                  impressão, desenvolvemos parcerias com artistas locais e
                  construímos uma comunidade de clientes fiéis que compartilham
                  nossa visão de moda autêntica.
                </p>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-card p-8 rounded-2xl shadow-sm">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Transformar a criatividade de nossos clientes em peças de
                vestuário únicas e de alta qualidade, democratizando a moda
                personalizada e permitindo que cada pessoa expresse sua
            ...
            <div className="bg-card p-8 rounded-2xl shadow-sm">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Ser reconhecida como a principal referência em moda customizada
                no Brasil, liderando a revolução da personalização no vestuário
                e inspirando pessoas a viverem sua autenticidade através da
                moda.
              </p>
            </div>
          </div>
