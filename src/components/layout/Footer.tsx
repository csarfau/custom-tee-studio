        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          <div className="lg:col-span-1">
            ...
            <p className="text-primary-foreground/70 text-sm leading-relaxed mb-6">
              Transformando sua criatividade em estilo único. Camisetas
              personalizadas de alta qualidade para quem quer se destacar.
            </p>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-primary-foreground/70 text-sm">
                  Av. Raja Gabáglia, 1000 - Belo Horizonte, MG
                </span>
              </li>
        ...
        <div className="mt-12 pt-8 border-t border-primary-foreground/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-primary-foreground/50 text-sm">
              © {new Date().getFullYear()} CustomTee. Todos os direitos
              reservados.
            </p>
